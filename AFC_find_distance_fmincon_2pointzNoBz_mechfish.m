...
points1  = [1588 2997 4249 5773 7069 8709 10190 11450];
...
for k = 1 : length(points1)
    for i = 1 : 15 
        ...
        a0=[0.3   0.1   0.1   5*pi/2    2.5*pi  1   1   1   0.1   0.1    pi/20   1   1   1   1 ];
        lb=[0.05 -0.15 -0.1   4.5*pi/2  1*pi   -60 -60 -60 -0.15 -0.1   -pi/6   -60 -60 -60 -60];
        ub=[0.6   0.15  0.1   7*pi/2    3*pi    60  60  60  0.15  0.1    pi/6    60  60  60  60];
